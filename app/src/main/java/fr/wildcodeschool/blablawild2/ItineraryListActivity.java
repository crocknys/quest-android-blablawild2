    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItineraries.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), listItineraries, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ItineraryModel depart = itineraryModels.get(position);
                 String name = depart.getDriver().toString();
                Toast.makeText(ItineraryListActivity.this, "Conducteur:" + name, Toast.LENGTH_SHORT).show();
